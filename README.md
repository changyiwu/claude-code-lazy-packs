...
| 編號 | 懶人包名稱 | 狀態 | 說明 |
|------|-----------|------|------|
| 00 | [環境建置](00-環境建置.md) | v0.2 | 安裝 Git、GitHub CLI、uv 等基礎工具 |
...
| 03 | [建立第二大腦 Obsidian](03-建立第二大腦-Obsidian.md) | v0.5 | 安裝 Obsidian + MCP 連接 + Google Drive 同步 |
| 04 | [第二大腦設定指南](04-第二大腦設定指南.md) | v1.0 | 三層結構 + CLAUDE.md + 模板 + 每週知識重整排程 |
| 05 | [連接 Supabase 資料庫](05-連接-Supabase-資料庫.md) | v0.2 | 連接雲端資料庫，讓程式「記得住」 |
| 06 | [連接 Firebase 資料庫](06-連接-Firebase-資料庫.md) | v0.7 | 對老師更友善的資料庫選擇（不會閒置暫停、千人研習撐得住、Firestore MCP 完整 CRUD） |
