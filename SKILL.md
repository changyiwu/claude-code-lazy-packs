...
| 05 | `05-supabase` | 連接 Supabase 資料庫 |
| 06 | `06-firebase` | 連接 Firebase 資料庫 |
| 07 | `07-ollama` | 安裝本地 AI Ollama |
| 08 | `08-gemini` | 設定 Gemini 免費 API |
| 09 | `09-draw` | 安裝 gpt-image-2 生圖 skill |
| — | `install-all` | 一次安裝全部 |
